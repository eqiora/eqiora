...
<a id="api-eqiora-ActivationRef"></a>

### `eqiora.ActivationRef`
...
class Component:
    ...
    @overload
    def field(self, name: str, *, on: Support | None=None, value_type: Record | ImportedRecord, role: FieldRole, at: Clock | None=None, doc: str | None=None) -> RecordField: ...
    @overload
...
<a id="api-eqiora-lang-ImportedRecord"></a>

### `eqiora.lang.ImportedRecord`
...
<a id="api-eqiora-lang-frobenius"></a>

### `eqiora.lang.frobenius`
...
### `eqiora.time.ForwardSensitivity`
...
### `eqiora.time.SensitivityTolerance`
