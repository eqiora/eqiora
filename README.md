...
<p align="center">
  ...
  <a href="https://docs.rs/eqiora/0.1.0-alpha.14/eqiora/"><img src="https://img.shields.io/crates/v/eqiora?style=flat-square&amp;logo=rust" alt="crates.io version"></a>
...
cd eqiora-demo
uv add "eqiora[gmsh,matplotlib]==0.1.0a14"
```
...
backends, or browse the [API docs](https://docs.rs/eqiora/0.1.0-alpha.14/eqiora/).
